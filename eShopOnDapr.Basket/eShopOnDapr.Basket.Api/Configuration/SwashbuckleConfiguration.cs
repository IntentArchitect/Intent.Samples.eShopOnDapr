...
using EShopOnDapr.Basket.Api.Filters;
...
namespace EShopOnDapr.Basket.Api.Configuration
{
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "eShopOnDapr.Basket API V1");
                    options.OAuthAppName("eShopOnDapr.Basket API");
