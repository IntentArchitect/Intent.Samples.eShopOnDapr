...
using EShopOnDapr.Ordering.Api.Filters;
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "eShopOnDapr.Ordering API V1");
                    options.OAuthAppName("eShopOnDapr.Ordering API");
