...
using EShopOnDapr.Ordering.Application.Common.Exceptions;
...
namespace EShopOnDapr.Ordering.Infrastructure.HttpClients
{
    public class NewServiceProxyHttpClient : INewServiceProxyClient
    {
        private readonly JsonSerializerOptions _serializerOptions;
        private readonly HttpClient _httpClient;

        public NewServiceProxyHttpClient(HttpClient httpClient)
        {
