...
using EShopOnDapr.Web.HttpAggregator.Api.Filters;
            ...
            services.AddSwaggerGen(
                options =>
                {
                    options.SwaggerDoc(
                        ...
                        {
                            Version = "v1",
                            Title = "eShopOnDapr.Web.HttpAggregator API",
                        });
        ...
        public static void UseSwashbuckle(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(
                options =>
                {
                    ...
                    options.SwaggerEndpoint("/swagger/v1/swagger.json", "eShopOnDapr.Web.HttpAggregator API V1");
                    options.OAuthAppName("eShopOnDapr.Web.HttpAggregator API");
